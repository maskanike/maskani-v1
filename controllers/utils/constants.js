...
'<img style="display: inline-block; height: 30px; width: auto; margin-left: auto; margin-right: auto;" alt="Logo" src="https://flatspad.com//images/flatspad_logo_white_bg.png"/>' +
...
'  <a style="color: #00ACC4;" href="/legal/terms) %>">Terms of Service</a>' +
'  <span style="color: #ccc;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>' +
'  <a style="color: #00ACC4;" href="/legal/privacy) %>">Privacy Policy</a>' +
'</div><p style="color: #777777; padding: 0 25px; max-width: 400px; box-sizing: border-box; margin-left: auto; margin-right: auto; font-size: 10px; text-align: center;">' +
'Please do not reply to this email. To get in touch with us, visit our <a style="color: #00ACC4;" href="/contact"> help center.</a> If you have not signed up for an account with us, please disregard this message.</p>' +
'</div>';
